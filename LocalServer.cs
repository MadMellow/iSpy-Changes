        ...
        private string DoCommand(string sRequest, int otid, string resp, string cmd, int oid, string fn, ref string func)
        {
            ...
            switch (cmd)
            {
                ...
                case "getgrabs":
                    ...
                    func = grabs.Replace("data", "\"" + grabs.Trim(',') + "\"");   
                    resp = "OK";
                    break;
                case "getlogfilelist":
                    {
            ...
            if (MainForm.Cameras != null && (ot == 0 || ot == 2))
            {
                ...
                foreach (objectsCamera oc in l)
                {
                    ...
                    if (cw != null)
                    {
                        ...
                        bool runningstatus = cw.GotImage;       
                        resp += "2," + oc.id + "," + onlinestatus.ToString().ToLower() + "," +
                                ...
                                oc.settings.accessgroups.Replace(",", "&comma;").Replace("\n", " ") + "," + oc.ptz + "," + talkconfigured.ToString().ToLower() + "," + 
                                oc.settings.micpair + "," + cw.Recording.ToString().ToLowerInvariant() + "," +
                                runningstatus.ToString().ToLowerInvariant() + Environment.NewLine; 
                    }
                }
            }
            if (MainForm.Microphones != null && (ot == 0 || ot == 1))
            {
                ...
                foreach (objectsMicrophone om in l)
                {
                    ...
                    if (vl != null)
                    {
                        ...
                        bool runningstatus = (vl.AudioSource != null && vl.AudioSource.IsRunning); 
                        resp += "1," + om.id + "," + onlinestatus.ToString().ToLower() + "," +
                            ...
                            recording.ToString().ToLowerInvariant() + "," +
                            runningstatus.ToString().ToLower()  + Environment.NewLine; 
                    }
                }
            }
